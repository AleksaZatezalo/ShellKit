...
class TestHTTPEncoder:
    ...
    def test_form_encoding(self, encoder):
        test_cases = [("hello world", "hello+world"), ("test param", "test+param")]
        for input_str, expected in test_cases:
    ...
    def test_encode_params(self, encoder):
        params = {"name": "test user", "id": "123", "query": "select * from users"}
    ...
    def test_encode_headers(self, encoder):
        headers = {"User-Agent": "test browser", "X-Custom-Header": "test value"}
